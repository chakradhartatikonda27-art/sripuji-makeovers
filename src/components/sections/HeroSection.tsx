...
export default function HeroSection() {
  return (
    <section style={{
      ...
      <div className="hero-grid" style={{ display: 'grid', gridTemplateColumns: '1.1fr 0.9fr', gap: '56px', alignItems: 'center', maxWidth: '1200px', margin: '0 auto', width: '100%', position: 'relative', zIndex: 1 }}>
        ...
        <div>
          ...
          <motion.div {...fade(0.40)} className="hero-btns" style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', marginBottom: '40px' }}>
            ...
            <a href="https://wa.me/918885397517" target="_blank" rel="noopener" style={{ background: '#25D366', color: '#fff', padding: '12px 20px', borderRadius: '6px', fontSize: '12px', fontWeight: 600, textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
          ...
          <motion.div {...fade(0.48)} className="hero-stats" style={{ display: 'flex', borderTop: '1px solid var(--border)', paddingTop: '28px' }}>
            {[
        ...
        <div className="hero-right" style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
